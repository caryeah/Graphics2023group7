...
void table()
{
    ...
    glPushMatrix();
    glTranslatef((table_width - leg_width) / 2 + 7.2, (table_length - leg_length) / 2 - 3, (table_height - leg_length) / 2 + 0.5); //leg1
    ...
    glPushMatrix();
    glTranslatef((table_width - leg_width) / 2 - 10.5, (table_length - leg_length) / 2 - 3, (table_height - leg_length) / 2 + 0.5); //leg2
    glScalef(leg_width, leg_length, leg_height);
    glTranslatef(-1, -1, -1);
    cube(0.53, 0.39, 0.28);
    glPopMatrix();
    ...
    glPushMatrix();
    glTranslatef((table_width - leg_width) / 2 - 10.5, (table_length - leg_length) / 2 - 3, (table_height - leg_length) / 2 + 4.5); //leg3
    glScalef(leg_width, leg_length, leg_height);
    glTranslatef(-1, -1, -1);
    cube(0.53, 0.39, 0.28);
    glPopMatrix();
